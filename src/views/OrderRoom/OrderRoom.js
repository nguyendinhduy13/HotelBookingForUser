...
const OrderRoom = ({ navigation, route }) => {
    ...
    const { userData, booking_date } = useSelector(state => state.global);

    const { payment_method, infoVehicle } = useSelector(
    ...
    const totalOrder = () => {
        ...
        const sum = Math.floor(
            dataRoom.price * (day === 1 ? day : day * (day / (day + 0.5))) +
                (infoVehicle ? infoVehicle.total_vehicle : 0),
        );
        return sum;
    };
    const image_default =
                        ...
                        <>
                            ...
                            <View
                                ...
                                <Text
                                    ...
                                    {formatDate(infoVehicle.start_date)} -{' '}
                                    {formatDate(infoVehicle.end_date)}
                                </Text>
                            </View>
                            <View
                                style={{
                    ...
                    <View style={{ marginTop: 10 }}>
                        <View
                            ...
                            <Text
                                ...
                                {FormatPrice(
                                    dataRoom.price * booking_date.total_night,
                                )}
                            </Text>
                        </View>
                        {booking_date.total_night > 1 && (
